...
var Histoslider = function (_Component) {
  ...
  _createClass(Histoslider, [{
    ...
    value: function render() {
      ...
      var start = Math.max(1, this.props.start || extent[0]);
      var end = this.props.end || extent[1];

      var innerWidth = this.props.width - this.props.padding * 2;
      var scale = (0, _d3Scale.scaleLog)().domain([start, end]).range([this.props.padding, innerWidth + this.props.padding]).base(1.7).clamp(true);
